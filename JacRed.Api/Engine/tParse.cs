...
public static class tParse
{
	...
	public static string ReplaceBadNames(string html) => html.Replace("Ванда/Вижн ", "ВандаВижн ")
		.Replace("Ё", "Е")
		.Replace("ё", "е")
		.Replace("щ", "ш");
	...
	public static DateTime ParseCreateTime(string line, string format)
	{
		...
		DateTime.TryParseExact(line.ToLower(), format, new CultureInfo("ru-RU"), DateTimeStyles.None,
			out var createTime);
