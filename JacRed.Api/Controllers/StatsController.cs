...
public class StatsController : Controller
{
    ...
    {
        if (!AppInit.conf.openstats) return Content(string.Empty);

        if (string.IsNullOrWhiteSpace(trackerName)) return Content(System.IO.File.ReadAllText("Data/temp/stats.json"));
