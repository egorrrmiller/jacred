...
public class TorrentEnricher : ITorrentEnricher
{
	...
	public TorrentEnricher(IMediaAnalyzerService mediaAnalyzer) => _mediaAnalyzer = mediaAnalyzer;
	...
	private HashSet<int> ExtractSeasons(string title, string[] types)
	{
		...
		if (string.IsNullOrWhiteSpace(title) || types == null)
		{
			return seasons;
		}

		// Только для сериалов и аниме
		if (!types.Contains("serial") && !types.Contains("anime"))
		{
			return seasons;
		}
