...
public class InitSchema : Migration
{
    public override void Up()
    {
        ...
        Create.Index("ix_torrents_tracker_sid").OnTable("torrents").InSchema(schema).OnColumn("tracker_name").Ascending().OnColumn("sid").Descending();
        Create.Index("ix_torrents_update_time").OnTable("torrents").InSchema(schema).OnColumn("update_time").Descending();
        ...
        Create.Index("ix_torrents_original_search_name_eq").OnTable("torrents").InSchema(schema).OnColumn("original_search_name");
        ...
        Create.Index("ix_search_queries_last_seen").OnTable("search_queries").InSchema(schema).OnColumn("last_seen").Descending();
    }
